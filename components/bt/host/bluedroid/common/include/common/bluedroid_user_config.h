...
#define UC_BT_HID_DEV_ENABLED               CONFIG_BT_HID_DEV_ENABLED
#else
#define UC_BT_HID_DEV_ENABLED               FALSE
#endif
...
#ifdef CONFIG_BT_LOG_HIDD_TRACE_LEVEL
#define UC_BT_LOG_HIDD_TRACE_LEVEL            CONFIG_BT_LOG_HIDD_TRACE_LEVEL
#else
